 ...
 * 3. Navigate to URL using Global Variable with Name value 'demoqa'
 * 4. Scroll to Element 'demoqa/Elements/Textbox/inputFullName' with value '0'
 * 5. Input the Element 'demoqa/Elements/Textbox/txtCurrentAddress' with the value of the local variable 'input'
...
// Navigate to URL using Global Variable with Name value 'demoqa'
WebUI.navigateToUrl(GlobalVariable.demotxt)
...
WebUI.setText(findTestObject('demoqa/Elements/Textbox/txtCurrentAddress'), input)
