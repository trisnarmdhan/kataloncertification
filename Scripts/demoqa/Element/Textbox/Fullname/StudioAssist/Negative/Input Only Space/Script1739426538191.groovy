 ...
 * 5. Input the Element 'demoqa/Elements/Textbox/inputFullName' with the value of the local variable 'input'
 ...
 * 8. Close Browser
 * 9. Add steps comment 'Field Name tetap muncul dengan value kosong'
 */
...
// Input the Element 'demoqa/Elements/Textbox/inputFullName' with the value of the local variable 'input'
WebUI.setText(findTestObject('demoqa/Elements/Textbox/inputFullName'), input)
...
// Add steps comment 'Field Name tetap muncul dengan value kosong'
WebUI.comment('Field Name tetap muncul dengan value kosong')