 ...
 * 4. Scroll to Element 'demoqa/Elements/Textbox/inputEmail' with value '0'
...
// Scroll to Element 'demoqa/Elements/Textbox/inputEmail'
WebUI.scrollToElement(findTestObject('demoqa/Elements/Textbox/inputEmail'), 0)
