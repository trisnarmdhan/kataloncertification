 ...
 * 3. Navigate to URL with value of the Test Data Value 'Data Files/GENERAL/URL' with column '1' and row '1'
...
// Navigate to URL with value of the Test Data Value 'Data Files/GENERAL/URL' with column '1' and row '1'
