 ...
 * 7. Click 'demoqa/Elements/Checkbox/cbxWordFile'
 * 8. Verify Text Present 'wordFile'
 * 9. Close Browser
 */
...
// Click 'demoqa/Elements/Checkbox/cbxWordFile'
WebUI.click(findTestObject('demoqa/Elements/Checkbox/cbxWordFile'))
