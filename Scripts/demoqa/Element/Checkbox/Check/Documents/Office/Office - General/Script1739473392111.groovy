 ...
 * 8. Click 'demoqa/Elements/Checkbox/cbxGeneral'
 * 9. Verify Text Present 'general'
 * 10. Close Browser
 */
...
// Click 'demoqa/Elements/Checkbox/cbxGeneral'
WebUI.click(findTestObject('demoqa/Elements/Checkbox/cbxGeneral'))
