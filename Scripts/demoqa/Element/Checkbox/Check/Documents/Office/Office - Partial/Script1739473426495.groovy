 ...
 * 7. Click 'demoqa/Elements/Checkbox/btnExpandOffice'
 * 8. Click 'demoqa/Elements/Checkbox/cbxPublic'
 * 9. Click 'demoqa/Elements/Checkbox/cbxPrivate'
 * 10. Verify Text Present 'public'
 * 11. Verify Text Present 'private'
 * 12. Close Browser
 */
...
// Click 'demoqa/Elements/Checkbox/btnExpandOffice'
WebUI.click(findTestObject('demoqa/Elements/Checkbox/btnExpandOffice'))

// Click 'demoqa/Elements/Checkbox/cbxPublic'
WebUI.click(findTestObject('demoqa/Elements/Checkbox/cbxPublic'))

// Click 'demoqa/Elements/Checkbox/cbxPrivate'
WebUI.click(findTestObject('demoqa/Elements/Checkbox/cbxPrivate'))

// Verify Text Present 'public'
WebUI.verifyTextPresent('public', false)

// Verify Text Present 'private'
