 ...
 * 8. Click 'demoqa/Elements/Checkbox/cbxClassified'
 * 9. Verify Text Present 'classified'
 * 10. Close Browser
 */
...
// Click 'demoqa/Elements/Checkbox/cbxClassified'
WebUI.click(findTestObject('demoqa/Elements/Checkbox/cbxClassified'))
