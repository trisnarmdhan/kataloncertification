 ...
 * 7. Click 'demoqa/Elements/Checkbox/cbxWorkspace'
...
// Click 'demoqa/Elements/Checkbox/cbxWorkspace'
WebUI.click(findTestObject('demoqa/Elements/Checkbox/cbxWorkspace'))
