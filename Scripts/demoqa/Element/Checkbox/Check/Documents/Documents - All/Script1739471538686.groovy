 ...
 * 6. Click 'demoqa/Elements/Checkbox/cbxDocuments'
 * 7. Verify Text Present 'documents'
 * 8. Verify Text Present 'workspace'
 * 9. Verify Text Present 'react'
 * 10. Verify Text Present 'angular'
 * 11. Verify Text Present 'veu'
 * 12. Verify Text Present 'office'
 * 13. Verify Text Present 'public'
 * 14. Verify Text Present 'privat'
 * 15. Verify Text Present 'classified'
 * 16. Verify Text Present 'general'
 * 17. Close Browser
 */
...
// Click 'demoqa/Elements/Checkbox/cbxDocuments'
WebUI.click(findTestObject('demoqa/Elements/Checkbox/cbxDocuments'))
