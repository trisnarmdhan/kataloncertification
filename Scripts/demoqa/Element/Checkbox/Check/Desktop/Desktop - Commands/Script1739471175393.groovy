 ...
 * 6. Click 'demoqa/Elements/Checkbox/btnExpandDesktop'
 * 7. Click 'demoqa/Elements/Checkbox/cbxCommands'
 * 8. Verify Text Present 'commands'
 * 9. Close Browser
*/
...
// Click 'demoqa/Elements/Checkbox/btnExpandDesktop'
WebUI.click(findTestObject('demoqa/Elements/Checkbox/btnExpandDesktop'))

// Click 'demoqa/Elements/Checkbox/cbxCommands'
WebUI.click(findTestObject('demoqa/Elements/Checkbox/cbxCommands'))
