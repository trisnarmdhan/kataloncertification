 ...
 * 7. Click 'demoqa/Elements/Checkbox/cbxNotes'
 * 8. Verify Text Present 'notes'
 * 9. Close Browser
*/
...
// Click 'demoqa/Elements/Checkbox/cbxNotes'
WebUI.click(findTestObject('demoqa/Elements/Checkbox/cbxNotes'))
